...
## 1.0.0-beta.7
- Nuevo motor geométrico individual V7 como vía principal de reconocimiento.
- Extracción de puntos locales distribuidos y descriptores binarios orientados de 256 bits.
- Matching contra las 78 referencias locales con ratio test y unicidad de correspondencias.
- Validación geométrica mediante homografía + RANSAC, con inliers, cobertura y error de reproyección.
- Rectificación a partir de la homografía y verificación secundaria con el descriptor visual Beta 6.
- El motor Beta 6.3 queda como fallback explícito cuando no existe geometría suficiente.
- El aviso previo de multicarta ya no bloquea por sí solo el análisis: V7 exige evidencia geométrica para el bloqueo definitivo.
- Detección de escenas con dos cartas mediante dos hipótesis fuertes espacialmente separadas.
- Se preservan orientación, cuatro esquinas, selección manual, 78/78 cartas, tiradas, aclaratorias e historial.
