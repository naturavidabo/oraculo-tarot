...
for(const marker of ['actions/checkout@v4','actions/setup-node@v4','npm run test:core','npm run build','actions/configure-pages@v5','actions/upload-pages-artifact@v3','actions/deploy-pages@v4']){
