...
export function MoreView(){
  ...
  return <section className="page">
    <span className="eyebrow">MÁS · ORÁCULO TAROT 1.0 BETA 5</span><h1>Herramientas</h1>
    ...
    <div className="section-title"><h2>Diagnóstico de cámara</h2><span>Beta 5</span></div>
    ...
    <div className="section-title"><h2>Funciones Beta 5</h2><span>autoencuadre 3.5</span></div>
    <div className="feature-card static"><b>📷 Autoencuadre 3.5 + orientación</b><span>Evalúa el encuadre antes de reconocer, compara rankings completos con varios recortes y elige un único encuadre ganador para las 78 cartas. La orientación permanece separada.</span></div>
