...
export function MoreView(){
  ...
  return <section className="page">
    <span className="eyebrow">MÁS · ORÁCULO TAROT 1.0 BETA 6</span><h1>Herramientas</h1>
    ...
    <div className="section-title"><h2>Diagnóstico de cámara</h2><span>Beta 6</span></div>
    ...
    <div className="section-title"><h2>Funciones Beta 6</h2><span>clasificación robusta 4.0</span></div>
    <div className="feature-card static"><b>📷 Clasificación robusta 4.0</b><span>Refuerza detalle fino, bordes, gradientes y color local; exige estabilidad entre pequeñas variaciones del encuadre y bloquea escenas con probable presencia de varias cartas.</span></div>
